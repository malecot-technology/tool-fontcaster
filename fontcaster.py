...
def render_variants_to_png(font_family, text, font_size, output_file, text_color, bg_color):
    padding = 10
...
def main():
    ...
    render_variants_to_png(args.font, args.text, args.font_size, args.output, text_color, bg_color)
